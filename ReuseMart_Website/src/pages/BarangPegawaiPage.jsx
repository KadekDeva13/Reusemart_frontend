          ...
          <Col key={barang.id_barang} md={4}>
            <Card className="h-100 shadow-sm">
              <Card.Body>
                ...
                <Card.Text>Harga: Rp{barang.harga_barang.toLocaleString("id-ID")}</Card.Text>
                <Button
                  variant="primary"
                  size="sm"
                  disabled={jabatan !== "CS"}
                  onClick={() => navigate(`/pegawai/diskusi/${barang.id_barang}`)}
                >
                  {jabatan === "CS" ? "Buka Diskusi" : "Diskusi (khusus CS)"}
                </Button>
              </Card.Body>
            </Card>
          </Col>
