      ...
      if (token) {
        axios.get("http://localhost:8000/api/user", {
          ...
          if (image) {
            ...
            const url = isFullUrl ? image : `http://localhost:8000/storage/foto_pembeli/${image}`;
            setAvatarUrl(url);
          } else {
          ...
          <div className="position-relative" ref={dropdownRef}>
            ...
            {showDropdown && (
              <div className="dropdown-menu show" style={{
                ...
                <button className="dropdown-item" onClick={() => navigate("/user/profile/pembeli")}>
                  Akun Saya
                </button>
                <button className="dropdown-item" onClick={() => navigate("/user/pembeli")}>
                  Home
                </button>
