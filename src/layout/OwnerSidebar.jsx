      ...
      <div>
        ...
        <div
          className={`flex items-center px-4 py-2 cursor-pointer font-semibold hover:bg-[#2c2d2f] ${
            activePage === "owner" ? "bg-[#798248] text-white" : ""
          }`}
        ...
        <div>
          ...
          <div
            className={`overflow-hidden transition-all duration-300 ${
              donasiOpen ? "max-h-40" : "max-h-0"
            }`}
          >
            <div
              className={`w-full py-2 pl-9 pr-2 cursor-pointer hover:bg-[#2c2d2f] ${
                activePage === "request-donasi"
                  ? "bg-[#798248] text-white font-semibold"
                  : ""
              }`}
        ...
        <div>
          ...
          >
            <div
              ...
              onClick={() =>
                navigate("/user/owner/laporan/laporan-penjualan-bulanan")
              }
            >
              Penjualan Bulanan
            </div>
          ...
          >
            <div
              ...
              onClick={() =>
                navigate("/user/owner/laporan/laporan-penjualan-kategori")
              }
            >
          ...
          >
            <div
              ...
              onClick={() =>
                navigate("/user/owner/laporan/laporan-masa-penitipan-habis")
              }
            >
          ...
          >
            <div
              ...
              onClick={() =>
                navigate("/user/owner/laporan/laporan-donasi-barang")
              }
            >
          ...
          >
            <div
              ...
              onClick={() =>
                navigate("/user/owner/laporan/laporan-request-donasi")
              }
            >
          ...
          >
            <div
              ...
              onClick={() =>
                navigate("/user/owner/laporan/laporan-transaksi-penitip")
              }
            >
          ...
          >
            <div
              ...
              onClick={() =>
                navigate("/user/owner/filter-kurir")
              }
            >
              Filter Kurir
            </div>
